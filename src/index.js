...
class Game extends Phaser.Game {
  constructor() {
    ...
    this.scene.add('Chapter2BossDialogue', new Dialogue('Chapter2EndDialogue', 'oasis', 'Chapter 2 - Boss', 'The boss appeared!', "Karl (Boss): 'Welcome, this will be the end,\nprepare yourself!'\nMartha: 'I'm ready to rumble!'", 'Game2', true));
    this.scene.add('Chapter3BossDialogue', new Dialogue('Chapter3EndDialogue', 'swamp', 'Chapter 3 - Boss', 'The boss appeared!', "Robert (Boss): 'Give up already,\nyou won't get past me!'\nMartha: 'Don't flatter yourself, come on!'", 'Game3', true));
    this.scene.add('Chapter4BossDialogue', new Dialogue('Chapter4EndDialogue', 'forest', 'Chapter 4 - Boss', 'The boss appeared!', "Hermann (Boss): 'This is the end of the road for you!'\nMartha: 'It is the end of the road, but not for me!'", 'Game4', true));
    this.scene.add('Chapter5BossDialogue', new Dialogue('Chapter5EndDialogue', 'river', 'Chapter 5 - Boss', 'The boss appeared!', "Heinrich (Boss): 'You have finally arrived,\nlet me give you a very warm welcome!'\nMartha: 'This is for my father, be gone!'", 'Game5', true));
    this.scene.add('Chapter6BossDialogue', new Dialogue('Chapter6EndDialogue', 'warzone', 'Chapter 6 - Boss', 'The boss appeared!', "Adolf (Boss): 'I can't believe you defeated\nmy commanders!' Martha: 'Release my father\nand give up right now if you want\nto live.' Adolf (Boss): 'Unfortunately\nfor you, this fight won't be as easy\nas the previous ones!'", 'Game6', true));
