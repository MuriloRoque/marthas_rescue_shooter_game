...
export default class Chapter3BossDialogueScene extends Phaser.Scene {
  constructor() {
    super('Chapter3BossDialogue');
  }
  ...
  create() {
    ...
    const dialog = this.rexUI.add.dialog({
      ...
      title: createLabel(this, 'Chapter 3 - Boss').setDraggable(),

      content: createLabel(this, 'The boss appeared!'),

      description: createLabel(this, "Robert (Boss): 'Give up already,\nyou won't get past me!'\nMartha: 'Don't flatter yourself, come on!'"),
