...
export default class Chapter4EndDialogueScene extends Phaser.Scene {
  constructor() {
    super('Chapter4EndDialogue');
  }
  ...
  create() {
    ...
    const dialog = this.rexUI.add.dialog({
      ...
      title: createLabel(this, 'Chapter 4 End').setDraggable(),
    ...
    dialog
      .on('button.click', function buttonClick() {
        this.scene.start('Chapter4Bonus');
      }, this)
