export default class Chapter5DialogueScene extends Phaser.Scene {
  constructor () {
    super('Chapter5Dialogue');
  }
  ...
  create () {
    ...
    var dialog = this.rexUI.add.dialog({
      ...
      title: createLabel(this, 'Chapter 5').setDraggable(),

      content: createLabel(this, 'Martha has arrived at the 5th command outpost.'),

      description: createLabel(this, "Martha: 'This is the last command post,\nthis must contain the final piece of the puzzle!'"),
